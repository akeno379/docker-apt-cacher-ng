sed 's/# ForeGround: 0/ForeGround: 1/' -i /etc/apt-cacher-ng/acng.conf \
 ...
 && echo 'Proxy: http://xx-net:8087 ' >> /etc/apt-cacher-ng/acng.conf \
 && echo 'OptProxyCheckInterval: 60 ' >> /etc/apt-cacher-ng/acng.conf \
 && echo 'OptProxyTimeout: 3 ' >> /etc/apt-cacher-ng/acng.conf \
